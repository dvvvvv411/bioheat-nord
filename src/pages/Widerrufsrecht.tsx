        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="shadow-lg mb-8">
            ...
            <CardContent className="space-y-4">
              <p className="text-gray-700 text-sm leading-relaxed">
                Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (BIO HEAT Nord GmbH, Lise-Meitner-Str. 22, 24941 Flensburg, E-Mail: info@bioheat-nord.de) mittels einer eindeutigen Erklärung (z.B. ein mit der Post versandter Brief, Telefax oder E-Mail) über Ihren Entschluss, diesen Vertrag zu widerrufen, informieren.
              </p>
              ...
              <div className="bg-primary-50 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-gray-700 text-sm">
                  ...
                  <p><span className="font-semibold">E-Mail:</span> info@bioheat-nord.de</p>
                </div>
              </div>
            ...
            <CardContent>
              <div className="bg-gray-50 p-6 rounded-lg border">
                ...
                <div className="space-y-4 text-gray-700 text-sm">
                  <p>An: BIO HEAT Nord GmbH, Lise-Meitner-Str. 22, 24941 Flensburg, E-Mail: info@bioheat-nord.de</p>
